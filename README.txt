...
"Virtual Bots Processor" - это пакет функций и всего необходимого чтобы делать простые симуляции с использованием самописного ИИ.
В этом пакете есть функции для простой но важной математики, функции для взаимодействия с ботами (ещё не все), и функции для генерации примитивного логического окружения (вот их пока нет).
...
map/sheets - папка предназначена для хранения уже готовых массивов уровней.
...
Все команды описаны в logic/interpreter.c и в logic/plans/plans.c . Для референса используется прототип написанный на Pascal. Он уже готов к компиляции.
